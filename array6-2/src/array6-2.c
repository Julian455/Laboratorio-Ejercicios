...
int ordenNegativos(int numeros[],int logitud);
int ordenarCreciteNeg(int numeros[],int logitud);
int encontrarNegativos(int numeros[],int logitud);
...
int ordenPositivo(int numeros[],int logitud)
{
	...
	if(numeros!=NULL && logitud>0)
	{
	   printf("\n\nOrden de los positivos de manera creciente\n ");
...
int ordenNegativos(int numeros[],int logitud)
{
	...
	if(numeros!=NULL && logitud>0)
	{
	   ...
	   encontrarNegativos(numeros, logitud);
	   ordenarCreciteNeg(numeros, logitud);
	   printf("\n ");
	   encontrarNegativos(numeros, logitud);
	   retorno=0;
	}
...
int encontrarNegativos(int numeros[],int logitud)
{
	...
	if(numeros!=NULL && logitud>0)
	{
		printf("Negativos econtrados");
		for(int i=0;i<logitud;i++)
		{
			negativos=signo(numeros[i]);
			if(negativos==-1)
			{
				printf("%d ",numeros[i]);
			}
